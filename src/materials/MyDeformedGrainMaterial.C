...
template <>
InputParameters
validParams<MyDeformedGrainMaterial>()
{
...
MyDeformedGrainMaterial::MyDeformedGrainMaterial(const InputParameters & parameters)
  : Material(parameters),
...
void
MyDeformedGrainMaterial::computeQpProperties()
{
