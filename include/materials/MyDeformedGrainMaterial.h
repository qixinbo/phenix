...
/****************************************************************/
#ifndef MYDEFORMEDGRAINMATERIAL_H
#define MYDEFORMEDGRAINMATERIAL_H

#include "Material.h"

// Forward Declarations
class MyDeformedGrainMaterial;
class GrainTrackerInterface;

template <>
InputParameters validParams<MyDeformedGrainMaterial>();
 ...
 */
class MyDeformedGrainMaterial : public Material
{
public:
  MyDeformedGrainMaterial(const InputParameters & parameters);
