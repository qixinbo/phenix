# This file is for only generating deformed grains, i.e, the original matrix grains
# 由PolycrystalVoronoi类生成，它需要明确给定grain_num晶粒数目这个参数。
# 它的父类PolycrystalUserObjectBase，则必需var_name_base和op_num这两个字段
